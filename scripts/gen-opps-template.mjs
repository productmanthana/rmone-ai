import ExcelJS from '/home/runner/workspace/node_modules/exceljs/dist/es5/exceljs.nodejs.js';
...
opps.forEach((opp, i) => {
  ...
  const totalD    = Math.round((fEnd - fStart) / 86400000);
  const pDays     = Math.round(totalD / numP);
