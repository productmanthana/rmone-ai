...
// with a "B" stuck on the end — "$2222225457.9B" — overflowing card layouts.
// Callers keep their own sub-billion tiers and delegate here only when the
// value is >= $1B. Keep in lockstep with rmone-web/src/lib/money.ts.
//
