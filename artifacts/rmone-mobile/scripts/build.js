...
function getDeploymentDomain() {
  ...
  if (process.env.DEV_PUBLIC_DOMAIN) {
    return stripProtocol(process.env.DEV_PUBLIC_DOMAIN);
  }
  ...
  console.error(
    "ERROR: No deployment domain found. Set INTERNAL_APP_DOMAIN, DEV_PUBLIC_DOMAIN, or EXPO_PUBLIC_DOMAIN",
  );
  process.exit(1);
}
